    ...
    return (
      <div className="app-container">
       <Header/>
        ...
        <p className="description text-primary fw-bold fs-4 ">
          Your skills and achievements <br/>showcase your strengths and abilities.
          <br/>
          Speak about<br/> any new skills or software you learnt to perform the
          project responsibilities.
        </p>

        <ul className="tabs-container d-flex justify-content-center">
